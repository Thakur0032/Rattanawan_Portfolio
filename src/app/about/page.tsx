      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-heavy p-8 rounded-[32px] border-white/5 relative overflow-hidden group">
          ...
          {/* Main Story */}
          <div className="lg:col-span-8 glass p-8 md:p-12 rounded-[32px] border-white/5 shadow-2xl relative">
