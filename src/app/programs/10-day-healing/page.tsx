  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="glass p-8 rounded-[32px] border-white/5">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-secondary/20 text-foreground/80 text-sm rounded-lg border border-secondary/20">Wellness Coaching</span>
                <span className="px-3 py-1.5 bg-secondary/20 text-foreground/80 text-sm rounded-lg border border-secondary/20">Life Coaching</span>
                <span className="px-3 py-1.5 bg-secondary/20 text-foreground/80 text-sm rounded-lg border border-secondary/20">Mindset Coaching</span>
                <span className="px-3 py-1.5 bg-secondary/20 text-foreground/80 text-sm rounded-lg border border-secondary/20">Transformational Coaching</span>
                <span className="px-3 py-1.5 bg-secondary/20 text-foreground/80 text-sm rounded-lg border border-secondary/20">Personal Growth</span>
              </div>
            </div>
          </div>
        ...
        {/* Bottom Callout */}
        <div className="max-w-4xl mx-auto glass-heavy p-10 rounded-[32px] text-center border-white/5 relative overflow-hidden">
