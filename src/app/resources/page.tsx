    ...
    <div className="pt-32 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          {/* Resource Card 1 */}
          <div className="glass p-8 rounded-[32px] border-white/5 hover:border-primary/50 transition-colors group">
        ...
        <div className="max-w-4xl mx-auto mt-16 glass-heavy p-10 rounded-[32px] border-white/5">
