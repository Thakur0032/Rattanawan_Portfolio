  ...
  return (
    <section className="py-12 bg-card border-y border-accent overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        <p className="text-center text-sm font-semibold text-muted-foreground/80 uppercase tracking-widest mb-8">
          Empowering Professionals Worldwide
        </p>
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-60">
          {/* Faux Logos for Business Feel */}
          <div className="font-heading font-bold text-xl text-foreground/90 flex items-center gap-2 hover:text-primary transition-colors cursor-default">
