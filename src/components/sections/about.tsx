...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 relative bg-[#FCFDFD]" ref={containerRef}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <motion.div 
            ...
            className="lg:col-span-7 bg-white p-8 md:p-12 rounded-[2rem] border border-slate-100 relative overflow-hidden group shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
          >
            ...
            <h3 className="text-2xl font-heading font-bold text-slate-800 mb-6 relative z-10">
              Heal the Mind, Elevate the Career.
            </h3>
            
            <div className="flex flex-col md:flex-row gap-8">
              <div className="md:w-1/3 relative z-10 shrink-0 flex items-start justify-center">
                <div className="w-full max-w-sm rounded-2xl overflow-hidden bg-white p-2 border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.05)]">
                  <img 
                    src="/images/img1.jpg" 
              ...
              <div className="md:w-2/3 space-y-4 text-slate-600 relative z-10 leading-relaxed text-[1.05rem]">
                <p>
            ...
            <div className="mt-8 flex flex-wrap gap-2 relative z-10">
              {skills.map((skill, idx) => (
                <span 
                  key={idx}
                  className="px-4 py-2 text-xs font-semibold bg-slate-50 border border-slate-200 rounded-lg text-slate-700 hover:bg-primary hover:text-white hover:border-primary transition-all cursor-default"
                >
                  {skill}
                </span>
              ))}
...
function StatCard({ icon, end, suffix, label, delay, isInView }: any) {
  ...
  return (
    <motion.div 
      ...
      className="bg-white p-6 rounded-2xl border border-slate-100 flex flex-col items-center justify-center text-center group hover:border-primary/50 transition-all duration-300 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(10,186,181,0.1)]"
    >
      ...
      <div className="text-4xl font-bold text-slate-800 mb-2 font-heading">
        {count}{suffix}
      </div>
